...
Version  : 0.18.0
Release  : 29
URL      : https://github.com/indygreg/python-zstandard/archive/0.18.0/python-zstandard-0.18.0.tar.gz
Source0  : https://github.com/indygreg/python-zstandard/archive/0.18.0/python-zstandard-0.18.0.tar.gz
...
%prep
%setup -q -n python-zstandard-0.18.0
cd %{_builddir}/python-zstandard-0.18.0
pushd ..
cp -a python-zstandard-0.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655822812
...
cp %{_builddir}/python-zstandard-0.18.0/LICENSE %{buildroot}/usr/share/package-licenses/python-zstandard/bdfd20ae0e3f88b5609da6191fbb89f33933d948
cp %{_builddir}/python-zstandard-0.18.0/zstd/COPYING %{buildroot}/usr/share/package-licenses/python-zstandard/1d8c93712cbc9117a9e55a7ff86cebd066c8bfd8
cp %{_builddir}/python-zstandard-0.18.0/zstd/LICENSE %{buildroot}/usr/share/package-licenses/python-zstandard/c4130945ca3d1f8ea4a3e8af36d3c18b2232116c
